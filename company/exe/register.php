<?php
    ...
    if($name =="" || $email == "" || $pass == ""){
        ...
        if($connect->num_rows > 0){
            ...
            $vkey = md5($email . time());
            $enpass = md5($pass);
            $stmt = $dbcon->prepare("INSERT INTO company(name,email,password,verify) VALUES(?,?,?,?)");
            ...
            if ($stmt->execute()) {
                ...
                $message = "
                        ...
                        <a href='http://localhost/job-portal/company/exe/verify.php?confirmkey=$vkey'>Confirm Your Account</a>
                    ";
