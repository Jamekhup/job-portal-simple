<?php
    ...
    $sql = "SELECT * FROM seeker WHERE email='$email' LIMIT 1";
    ...
    if(mysqli_num_rows($connect) > 0){
        while($com = mysqli_fetch_assoc($connect)){
            if($com['verify'] == 'verified'){
                ...
                $update = "UPDATE seeker SET resetpass='$resetkey' WHERE email='$email' LIMIT 1";
                if(mysqli_query($dbcon,$update)){
                    ...
                    $message = "
                                ...
                                <a href='http://localhost/job-portal/job-seeker/exe/update-pass.php?resetpasskey=$resetkey'>Click Here to Reset your Password</a>
                            ";
